...
namespace SNSDownloader.Twitter
{
    public static class TwitterUtils
    {
        ...
        public static IEnumerable<string> Domains { get; } = new string[] { "https://twitter.com", "https://x.com" };
        ...
        public static string GetLiveVideoStreamUrl(string mediaKey) => $"https://twitter.com/i/api/1.1/live_video_stream/status/{mediaKey}";
