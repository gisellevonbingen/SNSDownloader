...
namespace SNSDownloader
{
    public class Program
    {
        ...
        public static TwitterTimelineSearchDownloader TwitterTimelineDownloader { get; private set; }
        ...
        public static void Main()
        {
            ...
            try
            {
                ...
                Downloaders.Add(TwitterTimelineDownloader = new TwitterTimelineSearchDownloader());
